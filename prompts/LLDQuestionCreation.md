...
- A `README.md` with the requirements, written like an interviewer would explain them (a bit informal, some ambiguity left in on purpose)
...
- Do NOT show me your solution or explain the design in the README — I want to read the existing code myself and figure out how to correctly extend it
